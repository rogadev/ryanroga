/* empty css                                 */
import { c as createComponent, r as renderTemplate, a as addAttribute, b as renderHead, e as renderSlot, f as createAstro, m as maybeRenderHead, g as renderScript, h as renderComponent } from '../chunks/astro/server_-TpDul3A.mjs';
import 'kleur/colors';
import 'clsx';
...
Resume
</a> </div> </div> </nav> </header> ${renderScript($$result, "C:/Users/ryanr/Documents/dev/ryanroga/src/components/Navigation.astro?astro&type=script&index=0&lang.ts")} `;
...
Coming Soon
  ...
  --> <!-- AI Chat Section --> <!-- <div class='max-w-4xl mx-auto mt-12'>
      <AIChatHistory />
    </div> --> </div> ${renderScript($$result, "C:/Users/ryanr/Documents/dev/ryanroga/src/components/ResumeSection.astro?astro&type=script&index=0&lang.ts")} </section>`;
